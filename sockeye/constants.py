...
TARGET_NAME = "target"
TARGET_LABEL_NAME = "source_label"
...
METRIC_MAXIMIZE = {ACCURACY: True, BLEU: True, PERPLEXITY: False, DUAL:False}
METRIC_WORST = {ACCURACY: 0.0, BLEU: 0.0, PERPLEXITY: np.inf, DUAL:np.inf}
